...
-(instancetype)initWithFrame:(CGRect)frame{
    if ([super initWithFrame:frame]) {
        ...
        self.backgroundColor = [UIColor colorWithRed:103/255.0 green:103/255.0 blue:103/255.0 alpha:0.4];
        self.showView.frame = CGRectMake(ZY_SCREEN_W/2 - SCREEN_W/6, ZY_SCREEN_H/2 - SCREEN_W/6, ZY_SCREEN_W/3,ZY_SCREEN_W/3);
        self.showImage.frame = CGRectMake(ZY_SCREEN_W/6 - 30, 20, 60, 60);
...
-(void)updateFramestr:(NSString *)string size:(CGFloat)size{
    ...
    if (width > ZY_SCREEN_W/3 && width <= ZY_SCREEN_W - 60) {
        ...
        if (height > 30) {
            ...
            self.showImage.frame = CGRectMake((width + 10)/2 - 30, 20, 60, 60);
            ...
            self.showImage.frame = CGRectMake(width/2 - 30, 20, 60, 60);
        ...
        self.showView.frame = CGRectMake(ZY_SCREEN_W/2 - width/2 - 5, ZY_SCREEN_H/2 - SCREEN_W/6, width,ZY_SCREEN_W/3 + height - 30);
        self.showImage.frame = CGRectMake((width + 10)/2 - 30, 20, 60, 60);
        self.errorLabel.frame = CGRectMake(5, CGRectGetMaxY(self.showImage.frame) + 10, width, height);
        self.errorLabel.textAlignment = NSTextAlignmentLeft;
